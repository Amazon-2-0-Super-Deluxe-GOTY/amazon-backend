...
{
    public class RestoreUserCommandHandler : IRequestHandler<RestoreUserCommandRequest, Result<ClientProfile>>
    {
        private readonly DataContext _dataContext;
        private readonly TokenService _tokenService;
        private readonly IMapper _mapper;

        public RestoreUserCommandHandler(DataContext dataContext, TokenService tokenService, IMapper mapper)
        {
        ...
        public async Task<Result<ClientProfile>> Handle(RestoreUserCommandRequest request, CancellationToken cancellationToken)
        {
            ...
            User? user = await _dataContext.Users.FirstOrDefaultAsync(u => u.Id == Guid.Parse(request.userId) && u.DeletedAt != null);
            if (user == null)
            {
