...
namespace amazon_backend.Migrations
{
    ...
    [Migration("20240523190215_RemoveBindFromProductProperty")]
    partial class RemoveBindFromProductProperty
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CategoryCategoryPropertyKey", b =>
                {
                    b.Property<uint>("CategoriesId")
                        .HasColumnType("int unsigned");

                    b.Property<Guid>("CategoryPropertyKeysId")
                        .HasColumnType("char(36)");

                    b.HasKey("CategoriesId", "CategoryPropertyKeysId");
            ...
            modelBuilder.Entity("CategoryCategoryPropertyKey", b =>
                {
                    b.HasOne("amazon_backend.Data.Entity.Category", null)
                        .WithMany()
                    ...
                    b.HasOne("amazon_backend.Data.Entity.CategoryPropertyKey", null)
                        .WithMany()
                        .HasForeignKey("CategoryPropertyKeysId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
